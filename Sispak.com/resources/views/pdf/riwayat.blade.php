...
<body>
	...
	<div class="mt-5">
		<div class="alert alert-success">
			...
			<p>Berdasarkan dari gejala ditentukan oleh seorang pakar penyakit nilai CF yakni <b>{{ number_format(unserialize($riwayat->cf_max)[0], 3) }} ({{ number_format(unserialize($riwayat->cf_max)[0], 3) * 100 }}%)</b> yaitu <b>{{ unserialize($riwayat->cf_max)[1] }}</b></p>
		</div>
	</div>
</body>
</html>