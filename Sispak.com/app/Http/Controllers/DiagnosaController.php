    ...
    public function diagnosa(Request $request)
{
    ...
    $isAdminUser = auth()->check() && auth()->user()->hasRole('Admin');

    // If the user is an admin and the 'nama' field is provided, use it as the name
    if ($isAdminUser && $request->has('nama')) {
    ...
    // Set the user_id based on whether the user is an admin or not
    $user_id = $isAdminUser ? auth()->id() : null;
